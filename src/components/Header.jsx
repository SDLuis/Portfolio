      ...
      <div className=" w-8/12 md:w-9/12 xl:w-[1100px] mx-auto flex flex-col-reverse md:flex-row items-center justify-between">
        <div className="text-white font-dosis text-center md:text-left lg:mr-10 mt-5 md:mt-0 lg:-mt-20">
          <h2
            ...
            }  transform transition duration-[1700] ease-in-out text-2xl md:text-4xl font-bold text-blue-400`}
          >
          ...
          <h1
            className={`${
              animated ? "" : "translate-y-5 opacity-0"
            }  transform transition duration-[1700] ease-in-out font-bold text-xl sm:text-2xl`}
          >
          ...
          <div className="lg:hidden block">
            <ScrollLink to="tecnologies" href="#" smooth={true} spy={true}>
              <button
                ...
                }  transform transition duration-[1700] ease-in-out animate-float mt-10 rounded-lg bg-blue-800 py-3 px-9 text-xl uppercase text-gray-200 hover:bg-blue-600`}
              >
        ...
        <div
          className={`${
            animated ? "" : "translate-y-5 opacity-0"
          }  transform transition duration-[1700] ease-in-out ml-10 mt-5 lg:mt-0 text-left hidden lg:block`}
        >
          ...
          <ScrollLink to="tecnologies" href="#" smooth={true} spy={true}>
            <button
              className={`${
                animated ? "" : "translate-y-10 opacity-0"
              }  transform transition duration-[1700] ease-in-out animate-float bg-blue-800 py-3 px-9 text-xl uppercase mt-10 rounded-lg text-gray-200 hover:bg-blue-600`}
            >
              {content.header.btnText}
            </button>
          </ScrollLink>
